...
const DEFAULTS: Record<Lang, Required<ProfessionalsData>> = {
  pt: { title: "Quem está à frente do escritório", subtitle: "Conheça os profissionais responsáveis pela condução técnica de cada atendimento.", items: [
  ...
  es: { title: "Quiénes están al frente del estudio", subtitle: "Conoce a los profesionales responsables de brindar una atención técnica en cada asunto.", items: [
