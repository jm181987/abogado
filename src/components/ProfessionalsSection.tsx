...
const DEFAULTS: Record<Lang, Required<ProfessionalsData>> = {
  pt: { title: "Quem está à frente do escritório", subtitle: "Conheça os profissionais responsáveis pela condução técnica e responsável de cada atendimento.", items: [
  ...
  es: { title: "Quiénes están al frente del estudio", subtitle: "Conoce a los profesionales responsables de brindar una atención técnica y cuidadosa en cada asunto.", items: [
