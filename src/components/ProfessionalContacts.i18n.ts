export const professionalContactCopy = {
  es: {
    ...
    description: "Elige con quién deseas comunicarte. Cada botón abre una conversación directa con el profesional seleccionado.",
  ...
  pt: {
    ...
    description: "Escolha com quem deseja falar. Cada botão abre uma conversa direta com o profissional selecionado.",
