...
const FAVICON = "/favicon.ico?v=20260910-2";
const APPLE_TOUCH_ICON = "/navbar-logo.jpg";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: FAVICON, type: "image/x-icon" }, { rel: "shortcut icon", href: FAVICON, type: "image/x-icon" }, { rel: "apple-touch-icon", href: APPLE_TOUCH_ICON },
