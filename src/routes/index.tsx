            ...
            <div className="overflow-hidden rounded-[2rem] border border-border bg-card shadow-xl shadow-foreground/5">
              <div className="grid lg:grid-cols-[0.85fr_1.15fr]">
                <div className="bg-primary p-8 text-primary-foreground sm:p-10 lg:p-12">
                  ...
                  <p className="mt-6 max-w-md text-sm leading-6 text-primary-foreground/75 sm:text-base">{lang === "es" ? "Cuéntanos brevemente tu situación. Puedes comunicarte directamente con nuestro equipo para recibir orientación inicial con claridad y confidencialidad." : "Conte-nos brevemente sua situação. Você pode falar diretamente com nossa equipe para receber uma orientação inicial com clareza e confidencialidade."}</p>
