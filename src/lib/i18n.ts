...
export const translations = {
  es: {
    ...
    diff: {
      ...
      items: [
        { t: "Honorarios transparentes", d: "Presupuesto claro antes de comenzar, sin sorpresas." }, { t: "Atención ES/PT", d: "Nos comunicamos contigo en español o portugués con claridad." },
