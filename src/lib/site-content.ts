...
const CONTACT_COPY = {
  es: {
    ...
    parking: "",
    howto: "Cómo llegar",
    howto1: "A 3 cuadras de la Praça Internacional",
    howto2: "A 2 min en auto de Rivera (UY)",
    howto3: "Cerca del Supermercado Righi de Rua Uruguai",
    hours: "Horarios",
    hours1: "Lunes a viernes: 9:00 - 18:00",
    hours2: "Sábados: (con cita)",
  ...
  pt: {
    ...
    parking: "",
    howto: "Como chegar",
    howto1: "A 3 quadras da Praça Internacional",
    howto2: "A 2 min de carro de Rivera (UY)",
    howto3: "Próximo ao Supermercado Righi da Rua Uruguai",
    hours: "Horários",
    hours1: "Segunda a sexta: 9:00 - 18:00",
    hours2: "Sábados: (com hora marcada)",
